...
| :--- | :--- |
| **Networking** | CCNA & Network+ (In-Progress), Cisco IOS, Packet Tracer, Routing & Switching |
| **Automation** | Python, PowerShell, Zapier, ChatGPT Prompt Engineering |
| **Cloud & Ops** | AWS & Google Cloud Foundations, Microsoft Azure, Google Workspace Admin |
| **Management** | Technical Documentation, SOP Architecture, Project Management (Asana/Monday) |

---

## 🏛️ Agency Fulfillment: KodeKouncil
**KodeKouncil** is a Technical Solutions Agency. We bridge the gap between IT infrastructure and business operations by transforming chaotic workflows into automated, high-performance systems.

### 💼 Services Offered:
* **Email & Calendar Management**: Inbox organization and meeting management.
* **Documentation Architecture**: GitHub README overhauls, internal Wikis, and technical SOPs.
* **Process Automation**: Linking marketing to operations via Zapier, Python, and system architecture tools.
